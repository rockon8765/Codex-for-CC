...
| `tests/ai-install/run-posix.sh` | `637a99357e2a52d029953b2b7bfee509ff25bc82` | 🔴 ⚠️ 已隨 macOS 驗收回饋更新（舊值 `70562b77…` 作廢）|
| `tests/ai-install/run-posix-args.test.sh` | `ee8da03c7f29d16061026622220843a95523cfeb` | 🔴 新增 |
...
| B-6b | `bash tests/ai-install/run-posix-args.test.sh` | `TOTAL 13  PASS 13  FAIL 0`。⚠️ 2026-08-10 驗收後新增 —— 當時抓到 `--doc ""` 會**靜默退回預設文件**並印 95/0 exit 0，而參數解析在那之前沒有任何自動化守衛 |
